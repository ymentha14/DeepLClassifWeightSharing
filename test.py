...
print("Both models will first execute a 10 fold CV in order to obtain robust estimates of their respective accuracies. A classic train/test run is executed as well in order to really make sure that no overfits occures.\n\n")
sleep(1)
# Naive Model
############################
